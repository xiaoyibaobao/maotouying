<template>
  ...
  <div class="tab tab1">
    <el-form :model="ruleForm" class="demo-ruleForm" :rules="rules" ref="ruleForm" label-position="top">
      ...
      <!--step1:-->
      <!--<el-form :model="step1Form" class="demo-step1Form" ref="step1Form" label-position="top">
        ...
        &lt;!&ndash;签到方式&ndash;&gt;
        <el-form-item label="目标用户：" prop="createWay">
          &lt;!&ndash;<el-row>
            <el-col :span="19" style="width: 633px;">
              <el-radio-group v-model="step1Form.createWay">
        ...
        <transition name="list">
          <el-form-item label="" prop="" class="setSign" >

            <el-row :gutter="20" v-for="item of step1Form.cityList">

              <el-col>
                &lt;!&ndash;省&ndash;&gt;
                <el-select v-model="item.provName" placeholder="请输入省" :disabled="true">
                  <el-option
                    v-for="i in provData"
                    :key="i.provId"
                    :value="i.provName">
                ...
                &lt;!&ndash;市&ndash;&gt;
                <el-select v-model="item.cityName" placeholder="请输入市" :disabled="true">
                  <el-option
                ...
                &lt;!&ndash;运营商&ndash;&gt;
                <el-checkbox class="checkbox" v-model="item.userType" :disabled="true">移动用户</el-checkbox>
              </el-col>
            </el-row>
      ...
      <div class="step1">
        ...
        <el-form :model="step1Form" class="demo-step1Form" :rules="rules" ref="step1Form" label-position="top">
          ...
          <transition name="list">
            <el-form-item label="" prop="" class="setSign" v-show="step1Form.createWay == '1'">
              ...
              <el-row :gutter="20" v-for="(item,index) in step1Form.cityList">
                ...
                <el-col>
                  <!--省-->
                  <el-select v-model="item.provName" placeholder="请输入省" @change="provChange(index,item.provName,provData)" disabled>
                    <el-option
          ...
          <transition name="list">
            ...
            <v-export :downFileParms="downFileParms" :fileName="'自定义用户导出'" :fileType="'zip'" :type="'2'" v-show="step1Form.createWay == '2'">
            </v-export>
          </transition>
            ...
            <template slot-scope="scope">
              ...
              <el-table :data="scope.row.paraList">
                ...
                <el-table-column property="paraValue" label="配置值" :width="100">
                  <template slot-scope="scope">
                    <el-input  auto-complete="off" v-model="scope.row.paraValue" disabled></el-input>
                  </template>
                </el-table-column>
        ...
        if(!this.mydata.bUseMoniData){
          this.axios.post(this.api.getActBaseInfo, this.postdata_getActBaseInfo).then(res => {
            ...
            .catch(res => {
              ...
              console.log("网络异常，ajaxGetActBaseInfo !");
              console.log(res);
            });
        }
        else{
